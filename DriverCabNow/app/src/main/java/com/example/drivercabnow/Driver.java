...
public class Driver {
    private String Driver_email, Driver_name, Driver_phone, UPI_Id, Vehicle_no, Current_Location, License_no, Cab_type, Cab_status;
    ...
    public Driver(String Driver_email, String Driver_name, String Driver_phone, String Vehicle_no, String License_no, String Cab_type, String UPI_Id) {
        ...
        this.Current_Location = "null"; // Finally current location will be a string like "0.0000 0.0000 0.0000 0.0000"
